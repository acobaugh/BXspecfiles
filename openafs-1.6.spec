...
%changelog
* Mon Apr 04 2011 Andy Cobaugh <phalenor@bx.psu.edu> - 1.6.0pre4
- Bump version to 1.6.0pre4
- Install openafs.conf to .example to avoid overwriting existing file.

* Thu Feb 17 2011 Andy Cobaugh <phalenor@bx.psu.edu> - 1.6.0pre2
- Bump version to 1.6.0pre2

* Mon Jan 17 2011 Andy Cobaugh <phalenor@bx.psu.edu> - 1.6.0pre1
* Version bump to 1.6.0pre1
* don't install module to /kernel/fs/afs, as that's not correct
