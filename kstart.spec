...
Name: kstart
Version: 3.16
Summary: kstart - Kerberos kinit variant supporting ticket refreshing
License: MIT
Vendor: http://www.bx.psu.edu
URL: http://www.eyrie.org/~eagle/software/kstart/
Source: http://archives.eyrie.org/software/kerberos/kstart-%{version}.tar.gz
...
%build
PATH="/sbin:/bin:/usr/sbin:/usr/bin:$PATH" CC=cc \
...
- make work with pkgbuild on Solaris 10
